...
.. currentmodule:: trajtracker.paradigms.dchoice
...
- Determine the type of feedback stimulus (rectangle/pictures) by setting
  :attr:`~trajtracker.paradigms.dchoice.Config.feedback_stim_type` .
- Determine where the stimulus appears: set :attr:`~trajtracker.paradigms.dchoice.Config.feedback_stim_position`
  or rely on default positions by setting :attr:`~trajtracker.paradigms.dchoice.Config.feedback_place`
...
- Each trial can show either of two feedback stimuli. Set
  :attr:`~trajtracker.paradigms.dchoice.Config.feedback_select_by` to decide how to select one
...
.. autoinstanceattribute:: Config.feedback_stim_type
    ...
    - 'picture': Configure it via :attr:`~trajtracker.paradigms.dchoice.Config.feedback_pictures`
